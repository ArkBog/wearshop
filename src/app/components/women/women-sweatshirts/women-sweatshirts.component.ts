...
@Component({
  selector: 'app-women-sweatshirts',
  templateUrl: './women-sweatshirts.component.html',
  styleUrls: ['./women-sweatshirts.component.css']
})
export class WomenSweatshirtsComponent implements OnInit {
  constructor(
  ...
  products = this.productsService.products.filter((e) => e.sex === 'women' && e.type === 'Sweatshirts');
